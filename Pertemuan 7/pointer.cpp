...
int main () {
    ...
    // cout << "Isi variabel pointer_number = " << pointer_num << endl;
    ...
    // cout << "Isi variabel ptr_pointer_score " << pointer_score << " dan isi variabel yang ditunjuk oleh ptr_pointer_score " << **ptr_pointer_score << " alamat memori pointer_score " << &ptr_pointer_score << endl;
    // cout << endl;
